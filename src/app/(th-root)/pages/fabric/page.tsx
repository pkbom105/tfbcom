...
export default function NestedCollectionPage({ lang = "th" }: { lang?: string }) {
  const isEn = lang === "en";
  const t = (th: string, en: string) => isEn ? en : th;
  // --- 2. collection categories (tab names switch by lang) ---
  const collectionData = [
    { 
      id: "1", name: t("เสื้อยืด", "T-Shirt"), img: "/hp/5.png", path: "/02colour/tshirt",
      subOptions: [
        { 
            id: "s1-1", 
            label: "C0M 20", 
    ...
    { 
      id: "2", name: t("เสื้อโปโล", "Polo Shirt"), img: "/hp/6.png", path: "/02colour/tshirt",
      subOptions: [
    ...
    { 
      id: "3", name: t("เสื้อเชิ้ต", "Dress Shirt"), img: "/hp/7.png", path: "/02colour/shirt",
      subOptions: [
    ...
    { 
      id: "4", name: t("เสื้อเชิ้ตช่าง", "Mechanic Shirt"), img: "/hp/8.png", path: "/01collection/workshop",
      subOptions: [
    ...
    <div className="container mx-auto px-4 lg:px-12 py-16 font-noto">
      ...
      <Tabs defaultValue="1" className="w-full">
        <div className="flex justify-center mb-16 overflow-x-auto pb-4 scrollbar-hide">
          <TabsList className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-9 bg-slate-100/80 p-2 rounded-2xl md:rounded-[2rem] h-auto w-full max-w-7xl border border-slate-200 shadow-inner gap-1">
