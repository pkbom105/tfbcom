  ...
  const features = [
    {
      ...
      title: "Location",
      titleTh: isEn ? "Factory Location" : "ที่ตั้งโรงงาน",
      description: (
    ...
    },
    {
      ...
      title: "Call Us",
      titleTh: isEn ? "Phone Numbers" : "เบอร์โทรศัพท์",
      description: (
    ...
    },
    {
      ...
      title: "Social Media",
      titleTh: isEn ? "Other Channels" : "ช่องทางติดต่ออื่นๆ",
      description: (
        <div className="space-y-2 text-left mt-3 text-lg xl:text-xl">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-6">
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-400">{isEn ? "Fastest and most convenient" : "สะดวกและรวดเร็วที่สุด"}</p>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          >
            ...
            <p className="text-slate-500 text-xl xl:text-2xl font-medium max-w-3xl">
              {t("ติดต่อสอบถามข้อมูลการผลิตเสื้อโปโลและยูนิฟอร์มครบวงจร", "Contact us for comprehensive polo shirt and uniform production services.")} <br />
              {t("เรายินดีให้คำปรึกษาแก่ทุกองค์กร", "We are happy to provide consultation for all organizations.")}
            </p>
          </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 xl:gap-32 items-center">
          ...
          >
            ...
            <div className="space-y-8 text-slate-600 leading-relaxed text-xl xl:text-2xl font-medium italic">
              <p>
                <span className="font-black text-gray-900 not-italic">{t("บริษัท ทอฟฟี่ บูติก จำกัด", "Toffy Boutique Co., Ltd.")}</span> {t("เราคือโรงงานผลิตเสื้อผ้าสำเร็จรูปที่มีประสบการณ์ยาวนานกว่า 35 ปี ย่านพุทธบูชา-พระราม 2", "We are a garment factory with over 35 years of experience in the Phutthabucha-Rama 2 area.")}
              </p>
              <p className="not-italic text-lg xl:text-xl text-slate-500 font-normal">
                {t("เราเชี่ยวชาญการผลิตเสื้อโปโลพนักงาน ชุดยูนิฟอร์มองค์กร และสินค้าพรีเมียม โดยเน้นความประณีตในการตัดเย็บและการเลือกสรรเนื้อผ้าที่ดีที่สุด เพื่อส่งมอบความคุ้มค่าให้แก่ลูกค้าของเรา", "We specialize in producing staff polo shirts, corporate uniforms, and premium products, focusing on meticulous sewing and selecting the best fabrics to deliver value to our customers.")}
              </p>
            </div>
          ...
          >
            ...
            <div className="relative z-10 overflow-hidden rounded-[3rem] shadow-2xl group">
              <Image
                ...
                alt={t("โรงงานผลิตเสื้อโปโล", "Polo Shirt Factory")}
                width={1000}
                height={800}
        ...
        <div className="max-w-[1200px] mx-auto text-center space-y-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-500 text-xl xl:text-2xl font-medium max-w-2xl mx-auto">
              {t("โรงงานตั้งอยู่บนถนนพุทธบูชา เข้าออกได้สะดวกจากทางด่วนพระราม 9 หรือถนนกาญจนาภิเษก", "The factory is located on Phutthabucha Road, easily accessible from Rama 9 Expressway or Kanchanaphisek Road.")}
            </p>
          </div>
