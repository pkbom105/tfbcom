        ...
        <Tabs defaultValue="shirt" className="w-full">
          <div className="flex justify-center mb-12">
            <TabsList className="grid grid-cols-2 bg-slate-100/80 p-2 rounded-2xl md:rounded-[2rem] h-auto w-full max-w-2xl border border-slate-200 shadow-inner gap-1">
              <TabsTrigger value="shirt" className="rounded-xl transition-all font-bold text-slate-800 py-3 text-xs md:text-sm lg:text-base px-1 data-[state=active]:text-red-600 data-[state=active]:bg-white data-[state=active]:shadow-md">
                Men's Shirt
              </TabsTrigger>
              <TabsTrigger value="shirtw" className="rounded-xl transition-all font-bold text-slate-800 py-3 text-xs md:text-sm lg:text-base px-1 data-[state=active]:text-red-600 data-[state=active]:bg-white data-[state=active]:shadow-md">
                Women's Shirt
              </TabsTrigger>
            </TabsList>
          </div>
