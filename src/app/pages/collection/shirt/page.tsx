...
export default function ReadyToWearV229() {
  ...
  const tabItems = [
    { value: "shirt-a", label: "เชิ้ต A", title: "Shirt A Series", prefix: "PA", subColorTabs: createSubTabs("/01collection/shirt-a") },
    { value: "shirt-b", label: "เชิ้ต B", title: "Shirt B Series", prefix: "PB", subColorTabs: createSubTabs("/01collection/shirt-b/color") },
    { value: "shirt-c", label: "เชิ้ต C", title: "Polo C Series", prefix: "PC", subColorTabs: createSubTabs("/01collection/shirt-c/color") },
    { value: "shirt-d", label: "เชิ้ต D", title: "Shirt D Series", prefix: "PA", subColorTabs: createSubTabs("/01collection/shirt-d/color") },
    { value: "shirt-e", label: "เชิ้ต E", title: "Shirt E Series", prefix: "PB", subColorTabs: createSubTabs("/01collection/shirt-e/color") },
    { value: "shirt-f", label: "เชิ้ต F", title: "Shirt F Series", prefix: "PC", subColorTabs: createSubTabs("/01collection/shirt-f/color") },
    { value: "shirt-aa", label: "เชิ้ต AA", title: "Shirt AA Series", prefix: "PAA", subColorTabs: createSubTabs7("/01collection/shirt-aa/color") },
    { value: "shirt-collar", label: "ปกโปโล ", title: "Shirt Collar", prefix: "PB", subColorTabs: createSubTabs8("/01collection/shirt-collar/color") },
    { value: "shirt-arm", label: "แขนโปโล ", title: "Shirt Arm", prefix: "PC", subColorTabs: createSubTabs9("/01collection/polo-arm/color") },
